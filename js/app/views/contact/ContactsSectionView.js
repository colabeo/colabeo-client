...
//                    break;
        ...
        $('body').on('click', '.abcButton button', function(e){
            if (this.a2zindexArray[e.target.id] != undefined){
                console.log(this.a2zindexArray[e.target.id]);
                colabeo.contactsSection.scrollview.node.index= this.a2zindexArray[e.target.id];
            }
        }.bind(this));

//        this.abcSurface.on('click', function(e) {
//
//            var target = $(e.target);
//            if (this.a2zindexArray[target.id] != undefined){
//                console.log(this.a2zindexArray[target.id]);
//                colabeo.contactsSection.scrollview.node.index= this.a2zindexArray[target.id];
//            }
//        }.bind(this));
    }
        ...
        this.scrollview.sequenceFrom(this.collection.map(function(item) {
            ...
            if (!/^[a-zA-Z]+$/.test(item.get('lastname'))){
                if (firstChar != "#"){
                    ...
                    this.a2zindexArray[firstChar] = index;
                }
            }
